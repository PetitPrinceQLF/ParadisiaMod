...
public class deepslate_paradisium_ore {

    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, ParadisiaMod.MOD_ID);

    public static final RegistryObject<Block> DEEPSLATE_PARADISIUM_ORE = registerBlock("deepslate_paradisium_ore",
            () -> new Block(BlockBehaviour.Properties.of(Material.STONE).noOcclusion().strength(3F).explosionResistance(1).requiresCorrectToolForDrops()));
